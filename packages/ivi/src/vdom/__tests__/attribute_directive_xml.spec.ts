...
describe("attribute directive XLINK_ATTR", () => {
  describe("mount", () => {
    ...
    test("zero number", () => {
      const n = r(0);
      expect(n.getAttributeNS(ivi.XML_NAMESPACE, "text")).toBe("0");
      expect(setAttributeNS.mock.calls.length).toBe(1);
    });

    test("number", () => {
      const n = r(123);
      expect(n.getAttributeNS(ivi.XML_NAMESPACE, "text")).toBe("123");
      expect(setAttributeNS.mock.calls.length).toBe(1);
    });
  });
  ...
  describe("update", () => {
    ...
    test("empty string to undefined", () => {
      r("");
      const n = r();
      expect(n.getAttributeNS(ivi.XML_NAMESPACE, "text")).toBeNull();
      expect(setAttributeNS.mock.calls.length).toBe(1);
    ...
    test("string to different string", () => {
      r("abc");
      const n = r("def");
      expect(n.getAttributeNS(ivi.XML_NAMESPACE, "text")).toBe("def");
      expect(setAttributeNS.mock.calls.length).toBe(2);
      expect(removeAttribute.mock.calls.length).toBe(0);
    });
    ...
    test("number to different number", () => {
      r(123);
      const n = r(456);
      expect(n.getAttributeNS(ivi.XML_NAMESPACE, "text")).toBe("456");
      expect(setAttributeNS.mock.calls.length).toBe(2);
      expect(removeAttribute.mock.calls.length).toBe(0);
    });
