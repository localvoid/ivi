import { useResetDOM, useDOMElement, useIVI, useTest, useComputedValue, useHTML } from "ivi-jest";
import { Op } from "ivi";
  ...
  describe("stateful", () => {
    ...
    describe("watch", () => {
      describe("dirty checking", () => {
        test("observable", () => {
          const value = ivi.observable(1);
          const C = ivi.component(() => () => (ivi.watch(value), value.v));
          const result = r(C());
          ivi.assign(value, 2);
          t.dirtyCheck();
