...
// function visitNode(node: StateNode, parentTagName: string, ancestorFlags: AncestorFlags): void {
//   const flags = node.flags;

//   if ((flags & (NodeFlags.Element | NodeFlags.Text)) !== 0) {
//     const tagName = ((flags & NodeFlags.Text) !== 0) ? "$t" : node._t as string;
...
//     if ((flags & NodeFlags.Children) !== 0) {
//       let child = node._c as OpNode | null;
//       while (child !== null) {
//         visitNode(child, parentTagName, ancestorFlags);
//         child = child._r;
//       }
//     }
//   } else if ((flags & (NodeFlags.Component | NodeFlags.UpdateContext)) !== 0) {
//     visitNode(node._c as OpNode, parentTagName, ancestorFlags);
//   }
// }
